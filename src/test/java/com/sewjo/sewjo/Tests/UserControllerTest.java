...
public class UserControllerTest {
    ...
    public void testUploadProfilePicture_Success() throws Exception {
        ...
        assertEquals("myProfile/profile", result.getModelAndView().getViewName());
    }
    ...
    @Test
    public void testPasswordUpdate_UserNotLoggedIn() throws Exception {
        when(session.getAttribute("session_user")).thenReturn(null);
    ...
    public void testUpdateBio() throws Exception {
        MvcResult result = mockMvc.perform(post("/myProfile/updateBio")
                        .param("bio", "new-bio")
                        .sessionAttr("session_user", user))
                .andExpect(status().is3xxRedirection())
                .andReturn();
    ...
    @Test
    public void testUpdateBio_UserNotLoggedIn() throws Exception {
        when(session.getAttribute("session_user")).thenReturn(null);
    ...
    public void testUpdateName() throws Exception {
        MvcResult result = mockMvc.perform(post("/myProfile/updateName")
                        .param("name", "new-name")
                        .sessionAttr("session_user", user))
                .andExpect(status().is3xxRedirection())
                .andReturn();
    ...
    @Test
    public void testUpdateName_UserNotLoggedIn() throws Exception {
        when(session.getAttribute("session_user")).thenReturn(null);
